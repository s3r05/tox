...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>کوژمە ب سەرکەفتیانە هاتە دان </div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">قستێن گشتی  
...
<fieldset class="scheduler-border" >
    <legend  class="scheduler-border">لێگەریان :</legend>
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
    <label for="email"> ناڤێ قوتابی</label>
    <input type="text" class="form-control" id="student" name="student">
  </div>
  
   <div class="form-group">
    <label for="email">  مێژوا تۆمارکرنێ </label>
    <input type="text" class="form-control" id="doj" name="doj" >
  </div>
  
  <div class="form-group">
    <label for="email"> قۆناقا خواندنێ </label>
    <select  class="form-control" id="grade" name="grade" >
		<option value="" > قۆناغەکێ هەلبژێرە</option>
                                    <?php
   ...
   <button type="button" class="btn btn-success btn-sm" style="border-radius:0%" id="find" > لێگەریان </button>
  <button type="reset" class="btn btn-danger btn-sm" style="border-radius:0%" id="clear" > هەلوەشاندن </button>
</form>
</fieldset>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ناڤ /ژامارا موبایلێ </th>                                            
                                            <th>قستێ گشتی</th>
											<th>کۆژمێ مایی</th>
											<th> قۆناغا خواندنێ</th>
											<th> بەروارا تۆمارکرنێ</th>
											<th>گهۆرین</th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">  دانا قستی</h4>
        </div>
