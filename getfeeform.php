...
echo '  <form class="form-horizontal" id ="signupForm1" action="fees.php" method="post">
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">ناڤێ قوتابی </label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">ژمارا موبایلێ </label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email"> کوژمێ گشتی</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">کوژمێ مایی</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">کوژمێ هاتیە دان </label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email"> بەروار </label>
    <div class="col-sm-10">
   ...
   <div class="form-group">
    <label class="control-label col-sm-2" for="email">تێبینی</label>
    <div class="col-sm-10">
...
echo '
<h4> داتایێن پسولا گشتی</h4>
<div class="table-responsive">
<table class="table table-bordered">
    <thead>
      <tr>
        <th>بەروار</th>
        <th> کوژمێ هاتییە دان</th>
        <th>تێبینی</th>
      </tr>
    </thead>
    <tbody>';
