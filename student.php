...
<head>
    ...
    <title> سیستەمێ ب رێڤەبرنێ</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> برێڤەبرنا قوتابیان
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="student.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">  زڤرین بۆ پاشڤە </a>':'<a href="student.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> زێدەکرنا قوتابیەکێ نووی</a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? " زێدەکرنا داتایێن قوتابیەکێ نووی ": "گهۆرینا داتایێن قوتابی"; ?>
                        </div>
						<form action="student.php" method="post" id="signupForm1" class="form-horizontal">
                        <div class="panel-body">
						<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border"> زانیاریێن کەسی:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old"> ناڤێ سێ قولی* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="sname" name="sname" value="<?php echo $sname;?>"  />
								</div>
							</div>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">ژمارا موبایلێ * </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old"> قوناغا خواندنێ* </label>
								<div class="col-sm-10">
									<select  class="form-control" id="grade" name="grade" >
									<option value="" >هەلبژارتنا قوناغا خواندنێ*</option>
                                    <?php
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">بەروارا بەژداریکرنێ * </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="بەروارا بەژداریکرنێ" id="joindate" name="joindate" value="<?php echo  ($joindate!='')?date("Y-m-d", strtotime($joindate)):'';?>" style="background-color: #fff;" readonly />
								</div>
							</div>
						 </fieldset>
							...
							<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">داتایێن قستی :</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old"> قستێ کولیژێ* </label>
								<div class="col-sm-10">
						...
						?>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">کوژمێ دهێتە دان * </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">سەرجەم </label>
								<div class="col-sm-10">
						...
						?>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">  تێبینی </label>
								<div class="col-sm-10">
						...
						?>
							 ...
							 <fieldset class="scheduler-border" >
						 <legend  class="scheduler-border"> بتر...  :</legend>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">دەربارەی قوتابی  </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old"> پۆستێ ئەلکترۆنی </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								...
								<input type="hidden" name="action" value="<?php echo $action;?>">
									...
									<button type="submit" name="save" class="btn btn-success" style="border-radius:0%">زێدەکرن </button>
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    <thead>
                                        <tr>
                                            <th>ژمارە</th>
                                            <th>ناڤ/  ژلمارا موبایلێ</th>
											<th>قوناغا خواندنێ</th>
                                            <th> بەروارا بەژداریکرنێ</th>
                                            <th>قستی گشتی</th>
											<th>کوژمێ مایی</th>
											<th>گهۆرین</th>
                                        </tr>
